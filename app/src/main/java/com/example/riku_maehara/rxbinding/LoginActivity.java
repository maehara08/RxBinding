...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Observable<Boolean> passwordObservable = observePatternTextChange(passwordText, PASSWORD_PATTERN);

        // 上の2つの入力状態の監視結果に変更があった場合に通知が来るようにcombineLatestでまとめて監視を行います
        Observable.combineLatest(emailObservable, passwordObservable, new Func2<Boolean, Boolean, Boolean>() {
            @Override
        ...
        Button startButton=(Button)findViewById(R.id.mainActivityButton);
